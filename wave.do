...
add wave -noupdate -expand -group {Main Control} /tb_cpu/clk
...
add wave -noupdate -expand -group Execute -group ExRegister -radix unsigned /tb_cpu/u_vec_cpu/ex_reg2_data
add wave -noupdate -expand -group Execute -group ExRegister -radix unsigned /tb_cpu/u_vec_cpu/ex_immediate
add wave -noupdate -expand -group Execute -group ExRegister -radix unsigned /tb_cpu/u_vec_cpu/ex_vec1_data
add wave -noupdate -expand -group Execute -group ExRegister -radix unsigned /tb_cpu/u_vec_cpu/ex_vec2_data
add wave -noupdate -expand -group Execute -group ExRegister -radix unsigned /tb_cpu/u_vec_cpu/ex_shift_op
add wave -noupdate -expand -group Execute -group otherResults -radix unsigned /tb_cpu/u_vec_cpu/lut_vec_result
add wave -noupdate -expand -group Execute -group otherResults -radix unsigned /tb_cpu/u_vec_cpu/adder_esc_result
add wave -noupdate -expand -group Execute -group otherResults -radix unsigned /tb_cpu/u_vec_cpu/shifter_esc_result
...
add wave -noupdate -expand -group Execute -group {Escalar Regfile} /tb_cpu/u_vec_cpu/escalarRegs/rd_addr2
add wave -noupdate -expand -group Execute -group {Escalar Regfile} /tb_cpu/u_vec_cpu/escalarRegs/wr_addr
add wave -noupdate -expand -group Execute -group {Escalar Regfile} -radix unsigned /tb_cpu/u_vec_cpu/escalarRegs/wr_data
add wave -noupdate -expand -group Execute -group {Escalar Regfile} -radix unsigned /tb_cpu/u_vec_cpu/escalarRegs/reg1_data
